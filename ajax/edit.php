...
<?php        
        ...
        if($row5['program'] == "B.Tech.")$v1 = "checked = 'checked'"; 
        if($row5['program'] == "MCA")$v8 = "checked = 'checked'"; 
        ...
        if($row5['branch'] == "EN")$v6 = "checked = 'checked'";
                ...
                <h4>Edit student data </h4>
                    ...
                    <form enctype="multipart/form-data" id="edit_form" method="post" action="fill_edit.php?id=<?php echo($id)?>">
                        ...
                        <div>
                            ...
                            <input type="radio" name="prog" <?php echo($v1) ?> value="B.Tech." /><label>B.Tech.</label>
                            <input type="radio" name="prog" <?php echo($v8) ?> value="MCA" /><label>MCA</label>           
                        </div>
                        <div>
                            ...
                            <input type="radio" <?php echo($v6) ?> name="branch" value="EN" /><label>EN</label>
